...
const Contact = () => {
  ...
  return (
      <section id="contact" className="flex min-h-screen max-w-screen-xl p-4 pt-24 mx-auto">
        <div className="flex flex-col w-full items-center gap-4 lg:gap-6">
          ...
          <form className="flex flex-col min-w-full px-2 items-center justify-center" id="contact-form" onSubmit={(e) => sendEmail(e) }>
            ...
            <button type="submit" className="outline-btn">{ t('contact_send_btn') } <FontAwesomeIcon icon={faPaperPlane} /></button>
          </form>
        </div>
      </section>
  )
